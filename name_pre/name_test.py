...
def load_data(sentence):
    # 读取数据字典
    with open(r'F:\lzpython\PaddleOCR-develop\name_pre\data\dict.txt', 'r', encoding='utf-8') as f_data:
...
def pre(text):
    with fluid.dygraph.guard(place = fluid.CUDAPlace(0)):
        ...
        model_infer = CNN()
        model, _ = fluid.load_dygraph(r"F:\lzpython\PaddleOCR-develop\name_pre\save_dir\save_dir_39200.pdparams")
