...
def load_data(sentence):
    # 读取数据字典
    with open(r'F:\lzpython\PaddleOCR-develop\miaoshu\data\dict.txt', 'r', encoding='utf-8') as f_data:
...
def pre(text):
    with fluid.dygraph.guard(place = fluid.CUDAPlace(0)):
        ...
        model_infer = CNN()
        model, _ = fluid.load_dygraph("F:\lzpython\PaddleOCR-develop\miaoshu\save_dir\save_dir_3000.pdparams")
...
# pre("房产中介、房产信息咨询、车辆信息咨询（服务）。")
# txt_file="data/d.txt"
# csv_file="data/result1.csv"
# to_result(txt_file,csv_file)